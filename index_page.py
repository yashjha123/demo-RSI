...
avl_blank = pd.DataFrame(
    columns=["RSI", "lon", "lat", "pro_X", "pro_Y", "customdata", "label"]
).to_dict()
    ...
    children=[
        html.Div(
            ...
            children=[
                ...
                html.A(
                    html.Img(
                        id="logo_left",
                        src=app.get_asset_url("Picture2.png"),
        ...
        html.Div(
            ...
            children=[
                ...
                dcc.Link(
                    "Geostatistics Interpolation (RSI)",
                    href="rsi",
                    className="button",
                    style={"margin-left": "10px", "text-decoration": "None"},
                ),
                dcc.Link(
                    "Demo (Spatial Mapping)",
                    href="spatial_mapping",
                    className="button",
                    style={"margin-left": "10px", "text-decoration": "None"},
                ),
                html.A(
                    "LEARN MORE",
                    href="https://sites.google.com/ualberta.ca/drtaejkwon/home",
                    className="button",
                    style={"margin-left": "10px", "text-decoration": "None"},
                ),
                html.A(
                    ...
                    html.Img(
                        id="logo",
                        src="https://www.ualberta.ca/_assets/images/ua-logo-green.svg",
                    ),
                            ...
                            children=[
                                ...
                                dbc.Card(
                                    ...
                                    children=[
                                        ...
                                        ),  # TODO: determine if continuous or discrete slider is better
                                    ],
                                ),
                                # PLACEMENT
                                html.Div(id="menu-col-1"),
                            ],
                        ),
                        html.Br(),
                        dbc.Col(md=8, id="menu-col-2"),
                    ]
                ),
            ],
        ),
...
def HomePage():
    col1 = [
        ...
        dbc.Card(
            style={"height": "40vh"},
            children=[
                dbc.CardHeader("Deep Learning Prediction"),
                dbc.CardBody(
                    id="dl_prediction",
                    style={"display": "flex"},
    ...
    col2 = [
        dbc.Card(
            id="col-id",
            children=[
                dbc.CardHeader("Real-Time AVL Locations"),
                dbc.CardBody(
                    [
                        # html.Div(id="result"),
                        #  html.Div([
                        ...
                        dcc.Loading(
                            dcc.Graph(
                                id="AVL_map",
                                figure=go.Figure(
                                    data=locations_placeholder, layout=map_layout
                                ),
